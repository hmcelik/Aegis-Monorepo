...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  if (req.method === 'OPTIONS') {
    ...
    res.header(
      ...
      'Content-Type, Authorization, X-Telegram-Init-Data, ngrok-skip-browser-warning, X-Requested-With'
    );
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: '2.0.0',
      description:
        'Enhanced REST API for Telegram Moderation Bot with comprehensive analytics, logging system, and strike management',
    },
    servers: [
      {
        url: '/api/v1',
...
app.options('/api/v1/health', (req: Request, res: Response) => {
...
app.use('/api', (req: Request, res: Response, next: NextFunction) => {
  next(
    ApiError.fromType(
      ERROR_TYPES.ENDPOINT_NOT_FOUND,
