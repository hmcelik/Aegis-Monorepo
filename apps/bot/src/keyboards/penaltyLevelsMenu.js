...
export const penaltyLevelsKeyboard = (settings, chatId) => ({
  reply_markup: {
    inline_keyboard: [
      ...
      [
        {
          text: `🔔 Alert Level (current: ${settings.alertLevel})`,
          callback_data: `set_alert_level:${chatId}`,
        },
      ],
      [
        {
          text: `🔇 Mute Level (current: ${settings.muteLevel})`,
          callback_data: `set_mute_level:${chatId}`,
        },
      ],
      [
        {
          text: `👢 Kick Level (current: ${settings.kickLevel})`,
          callback_data: `set_kick_level:${chatId}`,
        },
      ],
      [
        {
          text: `🚫 Ban Level (current: ${settings.banLevel})`,
          callback_data: `set_ban_level:${chatId}`,
        },
      ],
